...
namespace NetBanking.Infra.Bus
{

    //Implementation of RabbitMQ Bus. This class is sealed.
    public sealed class RabbitMQBus : IEventBus
    {

        private readonly IMediator _mediator;

        //To hold references to event handlers
            ...
            where TH : IEventHandler<T>
        {
            ...
            if (_handlers[eventName].Any(s => s.GetType() == handlerType))
            {
                throw new ArgumentException(
                    $"Handler for '{handlerType.Name}' is already registered '{eventName}'", nameof(handlerType));
            }
